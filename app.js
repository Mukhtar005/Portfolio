...
const portfolioData = {
  "s1": {
    ...
    description: "Ответственный и целеустремленный студент. Легко осваиваю новые технологии и люблю решать сложные задачи. Умею работать в команде и брать на себя ответственность.",
  ...
  "s2": {
    ...
    description: "Креативный и внимательный к деталям. Специализируюсь на фронтенд-разработке, создаю современные и удобные интерфейсы.",
  ...
  "s3": {
    ...
    description: "Дисциплинированный и методичный. Успею всё и даже больше! Люблю работать с базами данных и создавать надёжные серверные решения.",
  ...
  "s4": {
    ...
    description: "Люблю backend-разработку и всё, что с ней связано. Создаю масштабируемые и безопасные веб-приложения.",
  ...
  "s5": {
    ...
    description: "Мобильная разработка — моя страсть! Создаю удобные и быстрые приложения для Android. Также увлекаюсь Java Enterprise.",
  ...
  "s6": {
    ...
    description: "Хорошо справляюсь как с фронтендом, так и с бэкендом. Умею находить общий язык с командой и выполнять задачи качественно.",
  ...
  "s7": {
    ...
    description: "Увлекаюсь компьютерной графикой и десктопными приложениями. Всегда довожу дела до конца и помогаю товарищам.",
  ...
  "s8": {
    ...
    description: "Серьёзный подход к учёбе и работе. Умею разбираться в сложных архитектурах и писать чистый код.",
  ...
  "s9": {
    ...
    description: "Люблю высоконагруженные системы и микросервисы. Успеваемость всегда на высоком уровне!",
  ...
  "s10": {
    ...
    description: "Стараюсь и постепенно осваиваю веб-разработку. Хорошо делаю сайты на WordPress и простые лендинги.",
  ...
  "s11": {
    ...
    description: "Интересуюсь анализом данных. Стараюсь активно участвовать в парах и улучшать свои навыки.",
  ...
  "s12": {
    ...
    description: "Разработка игр — моё хобби! Учусь создавать простые игры и 3D-модели.",
  ...
  "s13": {
    ...
    description: "Усердный студент, стараюсь во всём разобраться. Нравится работать с базами данных и простыми приложениями.",
  ...
  "s14": {
    ...
    description: "Пытаюсь освоить полный стек веб-разработки. Люблю учиться новому и применять на практике.",
  ...
  "s15": {
    ...
    description: "Люблю PHP и Laravel! Стараюсь создавать удобные и функциональные веб-приложения.",
  ...
  "s16": {
    ...
    description: "iOS-разработка — моя мечта! Учусь создавать приложения для iPhone и iPad.",
  ...
  "s17": {
    ...
    description: "Низкоуровневое программирование и системное администрирование — это круто! Успеваемость отличная.",
  ...
  "s18": {
    ...
    description: "Ответственно подхожу к любому заданию. Создаю современные реакт-приложения с красивым интерфейсом.",
  ...
  "s19": {
    ...
    description: "Каждый день улучшаю свои навыки мобильной разработки. Умею создавать стабильные приложения.",
  ...
  "s20": {
    ...
    description: "Очень люблю машинное обучение и анализ данных! Готовлюсь к карьере в Data Science.",
  ...
  "s21": {
    ...
    description: "С Svelte работаю быстро и получаю удовольствие! Создаю простые, но красивые приложения.",
  ...
  "s22": {
    ...
    description: "Unreal Engine — моя любовь! Учусь делать крутые 3D-игры и визуализации.",
  ...
  "s23": {
    ...
    description: "Ruby on Rails позволяет создавать приложения очень быстро! Успеваемость хорошая.",
  ...
  "s24": {
    ...
    description: "Функциональное программирование — это мощно! Учусь Elixir и Phoenix.",
  ...
  "s25": {
    ...
    description: "Верстка получается хорошо! Стараюсь сделать всё аккуратно и по стандартам.",
  ...
  "s26": {
    ...
    description: "Классический Java и базы данных — это фундамент! Уверенно работаю с ними.",
  ...
  "s27": {
    ...
    description: "Железо и низкоуровневое программирование — это то, что мне нравится!",
  ...
  "s28": {
    ...
    description: "Yii2 — мощный фреймворк! Использую его для создания сервисов для студентов.",
  ...
  "s29": {
    ...
    description: "Скрипты и автоматизация — моя стихия! Умею упростить рутинные задачи.",
  ...
  "s30": {
    ...
    description: "Flutter позволяет писать приложения для Android и iOS сразу! Это круто!",
